...
backend kubernetes-masters
    ...
    option tcp-check
    # Master 1
    server k8s-master-1 192.168.57.21:6443 check fall 3 rise 2
    # Master 2
    server k8s-master-2 192.168.57.22:6443 check fall 3 rise 2
    # Master 3
    server k8s-master-3 192.168.57.23:6443 check fall 3 rise 2
