...
## LimitRange
LimitRange — это объект Kubernetes, который ограничивает и задаёт значения по умолчанию
для потребления ресурсов (CPU, память, хранилище) в пространстве имён.

## ResourceQuota
Ограничивает суммарное потребление ресурсов всем namespace (например, общее количество Pod, CPU, памяти).
